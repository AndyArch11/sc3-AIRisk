        ...
        <>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><em><a href="https://www.iso.org/standard/56641.html" target="_blank" rel="noopener noreferrer" className="air-link">ISO/IEC 38507:2022</a></em>{" "} Information technology — Governance of IT — Governance implications of the use of artificial intelligence by organisations</li>
                ...
                <ul>
                    ...
                    <li><em><a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/assets/PDF/OWASP-Top-10-for-LLMs-v2025.pdf" target="_blank" rel="noopener noreferrer" className="air-link">OWASP Top 10 for LLMs - 2025</a></em>{" "} OWASP Top 10 threats for Large Language Models</li>
                </ul>
                ...
                <ol>
                    ...
                    <li><strong>🗺️ Map and Prioritise Risks</strong>
                        <ul>
                            ...
                            <ul>
                                ...
                                <li><strong>Objective and value alignment:</strong> alignment of AI system objectives with organisational values and goals</li>
                    ...
                    <li><strong>📈 Determine Maturity Level</strong>
                        <ul>
                            ...
                            <ul>
                                <li><a href="https://www.gartner.com/smarterwithgartner/the-cios-guide-to-artificial-intelligence" target="_blank" rel="noopener noreferrer">Gartner</a></li>
                                <ul>
                                    ...
                                    <li><strong>Level 4 Systematic:</strong> AI is pervasively used for digital process and chain transformation, and disruptive new digital business models. All new digital projects at least consider AI, and new products and services have embedded AI. Employees in process and application design understand the technology. AI-powered applications interact productively within the organisation and across the business ecosystem.</li>
                                    <li><strong>Level 5 Transformational:</strong> AI is part of the business DNA</li>
                                </ul>
                                <li><a href="https://www.microsoft.com/en-us/research/publication/responsible-ai-maturity-model/" target="_blank" rel="noopener noreferrer">Microsoft</a></li>
                                <ul>
                                ...
                                <li><a href="https://www.ibm.com/downloads/documents/us-en/107a02e948c8f48d" target="_blank" rel="noopener noreferrer">IBM</a></li>
                                <ul>
                                ...
                                <li><a href="https://s3.amazonaws.com/external_clips/3430107/AI-Maturity-Framework_White-Paper_EN.pdf" target="_blank" rel="noopener noreferrer">Element<sup>AI</sup></a></li>
                                <ul>
                                    <li><strong>Stage 1 Exploring:</strong> Exploring what AI is and what it can bring to your organisation. The organisation does not yet have an AI model or solution in production.</li>
                                    <li><strong>Stage 2 Experimenting:</strong> Experimenting with Proofs of Concept (POCs) and pilots. The organisation is trying to put AI into production and can do so in limited ways.</li>
                                    <li><strong>Stage 3 Formalising:</strong> Moving from POC/pilot to an AI solution in production. Putting AI solutions into production still requires significant organisational work at this stage.</li>
                                    <li><strong>Stage 4 Optimising:</strong> Scaling AI solution deployments efficiently as the number of deployed AI models increases. The organisation is approaching a factory of model production.</li>
                                    <li><strong>Stage 5 Transforming:</strong> Transforming the organisation itself through the use of AI. The organisation uses AI in how it operates across many critical areas of the business.</li>
                                </ul>
                                <li><a href="https://www.bcg.com/publications/2021/the-four-stages-of-responsible-ai-maturity" target="_blank" rel="noopener noreferrer">Boston Consulting Group</a></li>
                                <ul>
                                ...
                                <li><a href="https://www.salesforceairesearch.com/static/ethics/EthicalAIMaturityModel.pdf" target="_blank" rel="noopener noreferrer">Salesforce</a></li>
                                <ul>
                            ...
                            <ul>
                                <li>Element<sup>AI</sup> identifies 5 key areas across which AI maturity should be assessed:</li>
                                <ul>
                                    <li><strong>Strategy:</strong> Organizational vision and roadmap to sustain forward momentum for AI.</li>
                                    <li><strong>Data:</strong> Digital sources of truth for training, running and improving AI.</li>
                                    <li><strong>Technology:</strong> Tools, infrastructure and workflows for powering AI across the solution lifecycle.</li>
                                    <li><strong>People:</strong> Roles, skills and measures of success to work smarter with AI.</li>
                                    <li><strong>Governance:</strong> Policies, processes, and structures to ensure responsible and safe AI.</li>
                                </ul>
                            </ul>
